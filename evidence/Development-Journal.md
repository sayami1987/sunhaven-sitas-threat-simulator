...
This journal records actual engineering activity. Entries are appended after work
is performed. Tool execution is not evidence of student attendance or personal
demonstration. Commit references are added after Git creates each commit.
